...
static NSString *const MJExample40 = @"UITableView + 美团";
static NSString *const MJExample50 = @"UITableView + DF";
...
- (NSArray *)examples
{
    if (!_examples) {
        ...
        exam4.vcClass = [MJTableViewController class];
        exam4.titles = @[@"美团"];
        exam4.methods = @[@"example32"];
        
        MJExample *exam5 = [[MJExample alloc] init];
        exam5.header = MJExample50;
        exam5.vcClass = [MJTableViewController class];
        exam5.titles = @[@"DF"];
        exam5.methods = @[@"example33"];
        
        self.examples = @[exam5,exam4, exam0, exam1, exam2, exam3];
    }
    return _examples;
}
